...
def load_user(email):
    client = MongoClient("mongodb+srv://seanmichaeldoinog:sean123@employmentmatchingnlp.2fibl.mongodb.net/?retryWrites=true&w=majority&appName=EmploymentMatchingNLP") # Replace this with your own MongoDB url
    db = client["login"]
...
def login():
    ...
    if form.validate_on_submit():
        client = MongoClient("mongodb+srv://seanmichaeldoinog:sean123@employmentmatchingnlp.2fibl.mongodb.net/?retryWrites=true&w=majority&appName=EmploymentMatchingNLP")
        db = client["login"]
...
def register():
    ...
    if form.validate_on_submit():
        # No need to specify method; it uses the default method
